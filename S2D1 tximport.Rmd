...
#Selection method number 2
quantile90_incisor <- quantile(incisor@assays$RNA@meta.features$vst.variance.standardized, probs = c(0.1), na.rm = FALSE, names = TRUE, type = 7)
incisor <- FindVariableFeatures(incisor, selection.method = "vst", nfeatures = 2000)
...
incisor <- ScoreJackStraw(incisor, dims = 1:15)
...
VlnPlot(incisor, features = c("Csf1r", "C1qb"))
FeaturePlot(incisor, features = c("Mrc1", "Csf1r"))
